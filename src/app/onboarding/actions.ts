...
// =============================================================================
// Las 8 categorías que se ofrecen pre-seleccionadas en el onboarding.
// Mantener este array como source of truth — también se usa para el
// botón "Saltar" en el slide de categorías.
export const DEFAULT_ONBOARDING_CATEGORIES: Array<{
  emoji: string
  name: string
  description: string
}> = [
  { emoji: '🏠', name: 'Hogar', description: 'Alquiler, expensas, servicios (luz, gas, agua, internet), reparaciones y mantenimiento del hogar.' },
  { emoji: '🛒', name: 'Supermercado', description: 'Compras de alimentos, bebidas, artículos de limpieza e higiene personal en supermercados o almacenes.' },
