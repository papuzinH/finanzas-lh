  ...
  return (
    <>
      <div
        ...
        className="rounded-xl border border-slate-800 bg-surface-raised/30 p-4 flex flex-col justify-between hover:border-slate-700 transition-colors cursor-pointer active:scale-[0.98]"
      >
        <div>
          ...
          <div className="space-y-2 mb-4 pt-3 border-t border-slate-800/50">
            <p className="text-[9px] font-medium text-slate-400 uppercase tracking-wider mb-1">Movimientos del mes</p>
            {history.length > 0 ? (
              history.map((t, i) => (
              ...
              <p className="text-[9px] text-slate-400 italic">Sin movimientos</p>
            )}
          </div>
        </div>

        <div className="flex items-center gap-2 text-[10px] text-slate-400 bg-surface/50 py-1.5 px-2 rounded border border-slate-800/50">
