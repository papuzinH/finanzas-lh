...
const TYPE_CONFIG: Record<string, { label: string; className: string }> = {
  ...
  bond:         { label: 'Bono',         className: 'bg-warn/15 text-text border-warn/40' },
  on:           { label: 'ON',           className: 'bg-warn/15 text-text border-warn/40' },
  bopreal:      { label: 'Bopreal',      className: 'bg-warn/15 text-text border-warn/40' },
  lecap:        { label: 'Lecap',        className: 'bg-warn/15 text-text border-warn/40' },
  boncap:       { label: 'Boncap',       className: 'bg-warn/15 text-text border-warn/40' },
