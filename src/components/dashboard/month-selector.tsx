  ...
  return (
    <div className="flex items-center justify-center gap-6 py-6">
      <Link 
        ...
        className="group flex h-10 w-10 items-center justify-center rounded-full border border-slate-800 bg-slate-900/50 text-slate-400 transition-all hover:border-emerald-500/50 hover:bg-emerald-500/10 hover:text-emerald-500"
      ...
      <div className="flex flex-col items-center">
        <h2 className="text-xl font-bold capitalize tracking-tight text-slate-100">
